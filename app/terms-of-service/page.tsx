...
export const metadata: Metadata = {
  title: 'Terms of Service | KPS Worldwide Logistics',
  description: 'Terms of service and acceptable use governing KPS Worldwide Logistics online portals and logistics inquiries.',
};
