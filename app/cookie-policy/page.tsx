...
export const metadata: Metadata = {
  title: 'Cookie Policy | KPS Worldwide Logistics',
  description: 'How KPS Worldwide Logistics uses essential and analytical cookies to improve browsing experience.',
};
