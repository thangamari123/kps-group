...
export const metadata: Metadata = {
  title: 'Client Testimonials | KPS Worldwide Logistics',
  description: 'Direct feedback and evaluations from industrial manufacturers, energy enterprises, and global logistics clients partnering with KPS Worldwide Logistics.',
  keywords: ['KPS testimonials', 'logistics client reviews', 'customs broker feedback', 'Chennai freight reviews'],
};
