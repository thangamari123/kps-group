...
export const metadata: Metadata = {
  ...
  description: 'Explore comprehensive logistics services by KPS Worldwide Logistics: containerized shipping (FCL/LCL), freight forwarding, customs brokerage, project cargo, ODC transport, and warehousing.',
};
