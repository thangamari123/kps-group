...
import { Calendar, ChevronLeft, User, Folder, Bookmark } from 'lucide-react';
import PageHero from '../components/common/PageHero';

export default function BlogDetail() {
  const { blogId } = useParams();

  // Mock template content (clearly demarcated as architectural placeholders)
  const templateArticle = {
    title: blogId === 'template-customs-rules' 
      ? "Upcoming Customs Regulations Update" 
      : "Operational Logistics & Transit Innovations",
    category: blogId === 'template-customs-rules' 
      ? "Customs Brokerage" 
      : "Logistics",
    date: blogId === 'template-customs-rules' 
      ? "August 26, 2026" 
      : "August 20, 2026",
    image: blogId === 'template-customs-rules' 
